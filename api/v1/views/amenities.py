#!/usr/bin/python3
"""Flask route that provides JSON responses"""
...
@swag_from('F_yml/amenities_no_id.yml', methods=['GET', 'POST'])
def amenities_no_id(amenity_id=None):
    """Amenities route that handles HTTP requests without an ID given"""
...
@swag_from('F_yml/amenities_id.yml', methods=['GET', 'DELETE', 'PUT'])
def amenities_with_id(amenity_id=None):
    """Amenities route that handles HTTP requests with an ID given"""
