...
@swag_from('F_yml/cities_by_state.yml', methods=['GET', 'POST'])
def cities_per_state(state_id=None):
    """Cities route to handle HTTP methods for cities by state"""
...
@swag_from('F_yml/cities_id.yml', methods=['GET', 'DELETE', 'PUT'])
