...
@swag_from('F_yml/states_no_id.yml', methods=['GET', 'POST'])
def states_no_id():
    """States route to handle HTTP methods for states without ID"""
...
def states_with_id(state_id=None):
    """States route to handle HTTP methods for a state by ID"""
