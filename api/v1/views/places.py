...
@swag_from('F_yml/places_by_city.yml', methods=['GET', 'POST'])
@app_views.route('/cities/<city_id>/places', methods=['GET', 'POST'])
def places_per_city(city_id=None):
    """Places route to handle HTTP methods for places by city"""
...
@swag_from('F_yml/places_id.yml', methods=['GET', 'DELETE', 'PUT'])
@app_views.route('/places/<place_id>', methods=['GET', 'DELETE', 'PUT'])
def places_with_id(place_id=None):
    """Places route to handle HTTP methods for a given place"""
...
def places_search():
    """Places route to handle HTTP method for searching places"""
